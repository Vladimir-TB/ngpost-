...
public:
    enum class Opt {HELP = 0, LANG, VERSION, CONF, THEME_COLOR, THEME_MODE, UI_SCALE, QUICK_ADVANCED_VISIBLE, AUTO_ADVANCED_VISIBLE, QUICK_POST_ARCHIVE_PASSWORD, SHUTDOWN_CMD, CHECK, QUIET, PROXY_SOCKS5,
                    ...
                    OBFUSCATE, OBFUSCATE_FILE_NAME, INPUT_DIR, AUTO_DIR, MONITOR_DIR, DEL_AUTO,
...
private:
    ...
    QString       _themeMode;
    double        _uiScale;
    bool          _quickAdvancedVisible;
    bool          _autoAdvancedVisible;
    bool          _quickPostArchivePassword;
    ...
    static const QString sDisplayName;
    ...
    static constexpr const char *sPortableMarker = "portable.mode";
#else
...
private:
    ...
    QString _findBundledArchiver() const;
    void _detectBundledArchiver();
    ...
    QString _defaultConfigDirectory() const;
    QString _defaultConfigPath() const;
    QString _portableMarkerPath() const;
    bool _portableModeEnabled() const;
    QStringList _legacyDefaultConfigPaths() const;
    QString _prepareDefaultConfigPath(bool migrateLegacy = true);
    bool _ensureConfigDirectory(const QString &configPath) const;
    bool _writeTextFileAtomically(const QString &configPath, const QString &contents);
...
public:
    ...
    inline static const QString & displayName();
    inline static const QString & asciiArt();
    inline static QString asciiArtWithVersion();
    inline static QString brandedAsciiArt();
    inline static QString brandedAsciiArtWithVersion();
    ...
    inline static QStringList defaultPackAutoKeywords();
};
...
const QString &NgPost::displayName() { return sDisplayName; }
...
QString NgPost::brandedAsciiArt()
{
    return sDisplayName;
}

QString NgPost::brandedAsciiArtWithVersion()
{
    return QString("%1 v%2").arg(sDisplayName).arg(sVersion);
}
...
QStringList NgPost::defaultPackAutoKeywords()
{
    return QStringList{
        optionName(Opt::COMPRESS),
        optionName(Opt::GEN_NAME),
        optionName(Opt::GEN_PASS),
        optionName(Opt::GEN_PAR2)
    };
}
